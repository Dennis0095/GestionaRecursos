<%-- 
    Document   : menu
    Created on : 08/04/2022, 05:38:40 PM
    Author     : dnric
--%>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                Si desea más información puede <a target="_blank" href="">enviar un mensaje</a> al administrador.
                            </div>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group-append">
                                            <a class="btn btn-danger" href="">Agregar Equipo</a>
                                        </div>
                                    </div>
                                </div>
